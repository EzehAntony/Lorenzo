...
function Tickets() {
  ...
  return (
    <div>
      ...
      <div className="flex mt-4 w-screen px-2 justify-center items-center ">
        <button className="w-[48%] bg-[#0361DD] text-white py-4 rounded-md">
          Transfer
        </button>
        <button className="w-[48%] bg-[#F4F3F8] text-white py-4 rounded-md">
          Sell
        </button>
      </div>
