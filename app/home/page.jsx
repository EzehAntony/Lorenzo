...
function Home() {
    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            t1.to(g("#p1"), { opacity: .5, x: -40 })
                .to(g("#p21"), { opacity: .5, y: -30 })
                .to(g("#p22"), { opacity: .5, y: 10 })
                .to(g("#p31"), { opacity: .5, y: -30, rotate: 20 })
                .to(g("#p32"), { opacity: .5, x: 30, })
                .to(g("#p4"), { opacity: .5, y: -30, ease: "bounce" })
    ...
    return (
            <main id="home" ref={ref} className="home invisible overflow-x-hidden home min-h-[2000px]">
                <div className="hero flex w-screen overflow-hidden py-4 lg:h-screen -md:justify-center -md:flex-col  overflow-x-hidden relative md:h-[50vh] min-h-[500px]  justify-center items-center bg-[#fee8c8]">
                    ...
                    <div className="w-screen h-[100%]  -md:max-w-[200px] flex flex-col justify-center items-center lg:px-20  mt-[60px] lg:flex-row" >
                        ...
                        <div className="images order-1 flex lg:w-[40%] -md:mt-8 -md:w-[130%] justify-end items-end ">
